...
enum TableType { employeeList, attendance }
...
class DbController {
  ...
  openDb({required String tableName, required TableType tableType}) async {
    ...
    Database database = await openDatabase(
      ...
      onCreate: (Database db, int version) async {
        ...
        //     createTable(
        //         tableName: tableName, tableType: TableType.employeeList);
        //     break;
  ...
  insertData(
      ...
      required TableType tableType}) async {
    ...
    try {
      ...
      print(code);
      if (tableType == TableType.attendance) {
