...
Future<AttendanceSyncResponse> attendanceSync(
    {required context,required List<Map<String, dynamic>> employeeList}) async {
  // print(employeeList);
  ...
  // print(managerId);
  var response = await http.post(Uri.parse("${AppConstants.baseUrl}attendanceOffline"),headers: headers, body: json.encode({
